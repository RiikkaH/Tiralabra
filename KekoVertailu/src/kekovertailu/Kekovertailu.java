...
public class Kekovertailu {
    ...
    public static void mittaaJarjestamisenAikoja(){
        ...
        System.out.println("Binäärikeko: "+(System.currentTimeMillis()-alku));
        
        alku=System.currentTimeMillis();
        jarjesta.jarjestaDarykeolla(4);
        System.out.println("d-arykeko(4): "+(System.currentTimeMillis()-alku));
        
        alku=System.currentTimeMillis();
        jarjesta.jarjestaBinomikeolla();
        System.out.println("Binomikeko: "+(System.currentTimeMillis()-alku));
        
        alku=System.currentTimeMillis();
        jarjesta.jarjestaFibonaccikeolla();//ja miksi ihmeessä ei muka toimi??
        System.out.println("Fibonaccikeko: "+(System.currentTimeMillis()-alku));
    }
